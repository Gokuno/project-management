...
const ProjectHeader = ({ activeTab, setActiveTab }: Props) => {
  const [IsModaleNewTaskOpen, setIsModaleNewTaskOpen] = useState(false);


  return (
    <div className='px-4 xl:px-6'>
      <ModalNewProject
        isOpen={IsModaleNewTaskOpen}
        onClose={() => setIsModaleNewTaskOpen(false)}
      />
      <div className='pb-6 pt-6 lg:pb-4 lg:pt-8'>
        <Header name="Vista del Desarrollo del Proyecto"
          buttonComponent={
            <button
              className='flex items-center rounded-md bg-blue-primary px-3 py-2 text-white hover:bg-blue-600'
              onClick={() => setIsModaleNewTaskOpen(true)}
            >
