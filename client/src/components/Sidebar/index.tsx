  ...
  return (
    <div className={sidebarClassNames}>
      <div className='flex h-full w-full flex-col justify-start'>
        {/* LOGO izq superior */}
        <div className='z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-4 dark:bg-black'>
        ...
        {/* ENLACES A PRIORIDADES */}
        <button
          onClick={() => setShowPriority((prev) => !prev)}
          className='flex w-full items-center justify-between px-6 py-4 text-gray-500'
        >
  ...
  return (
    <Link href={href} className='w-full'>
      ...
      >
        ...
        <Icon className='size-6 text-gray-800 dark:text-gray-200' />
